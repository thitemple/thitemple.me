...
<section class="relative isolate py-24">
	<div class="mx-auto max-w-7xl px-6">
		<div class="mx-auto max-w-4xl text-center">
			<h1 class="gradient-text mb-8 font-grotesk text-5xl font-extrabold lg:text-6xl">
				About Me
			</h1>
...
<section class="pb-32">
	<div class="mx-auto max-w-4xl px-6">
		...
		<div class="mb-16 text-center">
			...
			/>
			<h2 class="mb-4 font-grotesk text-3xl font-bold text-white">Hi, I'm Thiago Temple</h2>
			<p class="text-lg text-slate-300">
				A Brazilian currently residing and working in Ottawa, Canada. You can reach me on
				<a href="https://twitter.com/ThiagoTemple" class="text-[var(--accent)] hover:underline">Twitter</a> 
				or via 
		...
		<div class="space-y-12">
			...
			<div class="rounded-2xl border border-white/10 bg-black/30 p-8">
				...
				<p class="text-lg leading-relaxed text-slate-300">
					I am a staff developer at <a href="http://shopify.com" class="text-[var(--accent)] hover:underline">Shopify</a>, 
			...
			<div class="rounded-2xl border border-white/10 bg-black/30 p-8">
				...
				<p class="text-lg leading-relaxed text-slate-300">
					...
					driving force for me, along with the knowledge that the software I help build contributes to
			...
			<div class="rounded-2xl border border-white/10 bg-black/30 p-8">
				...
				<p class="text-lg leading-relaxed text-slate-300">
					...
					Additionally, I am eager to share the new things I learn and contribute to the community by
			...
			<div class="rounded-2xl border border-white/10 bg-black/30 p-8">
				...
				<div class="space-y-4 text-lg leading-relaxed text-slate-300">
					<p>
						Living in Canada, I have discovered a new passion due to its harsh winters: board games. I
						now thoroughly enjoy them and have been steadily growing my collection.
					</p>
					
					<div class="my-6">
						<a href="https://boardgamegeek.com/user/vintem" class="inline-block">
							<img
					...
					<p>
						...
						<a href="https://www.tvtime.com/en/user/13947508/profile" class="text-[var(--accent)] hover:underline"> TV shows </a>
					...
					<p>
						...
						and a proud father of three kids, as well as the owner of two cuddly greyhounds.
					</p>
				</div>
			</div>
		</div>
		...
		<!-- Call to Action -->
		<div class="mt-16 rounded-2xl border border-[var(--accent)]/20 bg-gradient-to-br from-purple-600/20 to-blue-600/20 p-8 text-center">
			...
			<div class="flex flex-wrap justify-center gap-4">
					...
					<a
						...
						class="group inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-base font-medium transition-all hover:border-[#00A8E8] hover:bg-[#00A8E8]/10 hover:text-[#00A8E8]"
					>
						<svg viewBox="0 0 24 24" class="h-5 w-5 fill-current transition-transform group-hover:scale-110">
					...
					<a
						...
						class="group inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-base font-medium transition-all hover:border-white hover:bg-white/10 hover:text-white"
					>
					...
					<a
						...
						class="group inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-base font-medium transition-all hover:border-[#0077b5] hover:bg-[#0077b5]/10 hover:text-[#0077b5]"
					>
						<Linkedin size={20} class="transition-transform group-hover:scale-110" />
						<span>LinkedIn</span>
					</a>
					<a
					...
					<a
						...
						class="group inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-base font-medium transition-all hover:border-[#E4405F] hover:bg-[#E4405F]/10 hover:text-[#E4405F]"
					>
						<Instagram size={20} class="transition-transform group-hover:scale-110" />
						<span>Instagram</span>
					</a>
			</div>
		</div>
