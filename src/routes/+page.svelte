<script lang="ts">
	...
	import { buildJsonLdScriptTag } from "$lib/json-ld";
	...
	// og:image/twitter:image must be absolute — the raw import resolves to a
	// root-relative build path, which crawlers and share previews won't fetch.
	const ogImage = `${config.url}${ThiagoPortraitRaw}`;

	const personSchema = {
		"@context": "https://schema.org",
		"@type": "Person",
		name: config.author,
		alternateName: "Mr. Food Programmer",
		url: config.url,
		image: ogImage,
	...
	const personSchemaScriptTag = buildJsonLdScriptTag(personSchema);
</script>
...
<svelte:head>
	...
	<meta property="og:image:alt" content="Thiago Temple, Mr. Food Programmer" />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content={config.title} />
	<meta name="twitter:description" content={config.description} />
	<meta name="twitter:image" content={ogImage} />
	{@html personSchemaScriptTag}
</svelte:head>
...
<div class="shell">
	...
	<section class="links-section">
		<div class="links-grid">
			<a href="https://mrfoodprogrammer.com" target="_blank" rel="me noopener" class="link-card">
	...
	<section class="latest-section">
		...
		<div class="latest-grid">
			{#each latestCards as card (card.slot)}
				<a href={card.url} target="_blank" rel="noopener" class="latest-card">
					{#if card.image}
	...
	<section id="developer" class="dev-section">
		<div class="dev-panel">
			...
			<div class="dev-links">
				<a href="https://github.com/thitemple" target="_blank" rel="me noopener" class="dev-row">
