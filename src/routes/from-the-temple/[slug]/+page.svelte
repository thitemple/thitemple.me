...
<section class="relative overflow-hidden pt-10 pb-16">
	...
	<div class="relative z-10 mx-auto max-w-3xl px-6">
		<div class="mb-8 flex flex-wrap items-center gap-4 text-sm">
			<span
				class="rounded-full bg-[var(--color-secondary)]/20 px-3 py-1 text-xs font-semibold text-[var(--color-secondary)]"
			>
				{getIssueLabel(data.meta.issue)}
			</span>
...
<article data-pagefind-body class="pt-8 pb-20">
	<div class="mx-auto max-w-3xl px-6">
		<div class="sr-only" aria-hidden="true">
			<span data-pagefind-meta="content_type:Newsletter"></span>
